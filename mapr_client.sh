...
MAPR_CLUSTER=lk.ke-cluster.com
MAPR_CLDB_HOSTS=ip-172-31-38-52.us-west-2.compute.internal,ip-172-31-42-23.us-west-2.compute.internal,ip-172-31-44-242.us-west-2.compute.internal
...
docker run --rm -it -d $MAPR_DOCKER_ARGS kyligence/keonmapr:latest "$@"
